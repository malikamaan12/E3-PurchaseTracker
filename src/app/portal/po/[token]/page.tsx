      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="p-5 rounded-3xl bg-slate-900 border border-slate-800 space-y-2">
            ...
            <p className="font-bold text-white text-sm pt-1">E3 Management Solutions & Logistics</p>
            ...
            <p className="text-xs text-slate-400">Governance: Institutional Electronic Procurement</p>
          </div>
        </div>
