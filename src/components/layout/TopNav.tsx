  ...
  return (
    <header className="h-20 border-b border-white/5 bg-zinc-950/50 backdrop-blur-xl px-12 flex items-center sticky top-0 z-40">
      ...
      <div className="flex items-center gap-6">
        ...
        <button className="flex items-center gap-2 bg-brand-primary/10 text-brand-primary px-4 py-2 rounded-xl text-xs font-bold hover:bg-brand-primary/20 transition-all group scale-lg">
